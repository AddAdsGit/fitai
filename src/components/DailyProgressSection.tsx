...
export function DailyProgressSection({
  ...
  return (
    <div className="px-4 sm:px-6 mt-4 relative z-10">
      ...
      <div className="relative w-full aspect-square max-w-[280px] mx-auto flex items-center justify-center my-6 sm:my-8">
        <svg
        ...
        <div className="text-center z-10 bg-white/40 backdrop-blur-md w-36 sm:w-40 h-36 sm:h-40 rounded-full flex flex-col items-center justify-center shadow-inner border border-white/50">
          <div className="text-4xl sm:text-5xl font-black mb-1 text-orange-950 px-2 truncate selection:bg-orange-500 select-none">
            {totalCalories.toLocaleString()}
          </div>
          <div className="h-1.5 w-8 bg-orange-500 rounded-full mb-1" />
          <div className="text-orange-900/50 font-black tracking-[0.1em] text-[9px] sm:text-[10px] uppercase">
      ...
      {(() => {
        ...
        return (
          <div className="mt-5 sm:mt-6 flex flex-col gap-3">
            <div className="bg-white/60 backdrop-blur-md p-4 sm:p-6 rounded-[28px] sm:rounded-[32px] border border-white/80 shadow-xl shadow-orange-100/20 overflow-hidden">
              {pages.length === 1 ? (
                <div className="grid grid-cols-2 gap-x-3 sm:gap-x-6 gap-y-4 sm:gap-y-5">
                ...
                >
                  {pages.map((pageItems, pageIdx) => (
                    <div
                      key={pageIdx}
                      className="w-full shrink-0 snap-center grid grid-cols-2 gap-x-3 sm:gap-x-6 gap-y-4 sm:gap-y-5"
                    >
