...
export function DailyProgressSection({
  ...
  return (
    <div className="px-4 sm:px-6 mt-2 sm:mt-4 relative z-10">
      {/* Circular Progress for Calories */}
      <div className="relative w-full aspect-square max-w-[210px] sm:max-w-[240px] mx-auto flex items-center justify-center my-4 sm:my-6">
        <svg
        ...
        <div className="text-center z-10 bg-white/40 backdrop-blur-md w-32 h-32 sm:w-36 sm:h-36 rounded-full flex flex-col items-center justify-center shadow-inner border border-white/50">
          <div className="text-3xl sm:text-4xl font-black mb-0.5 text-orange-950 px-2 truncate selection:bg-orange-500 select-none font-sans">
              ...
              {pages.length === 1 ? (
                ...
                >
                  {pages.map((pageItems, pageIdx) => (
                    <div
                      key={pageIdx}
                      className="w-full shrink-0 snap-center grid grid-cols-2 gap-x-4 gap-y-3.5"
                    >
