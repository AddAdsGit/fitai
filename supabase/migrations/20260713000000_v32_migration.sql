...
ALTER TABLE public.profiles 
  ...
  ADD COLUMN IF NOT EXISTS agent_config jsonb DEFAULT '{"showGptWidget": true, "generateImages": true, "refinePhotos": false, "artStyle": "gourmet", "trackWeight": true, "customInstructions": "Be a hyper-efficient fitness assistant. Minimize chit-chat. Keep replies extremely concise. Prefix macro estimations with ≈. Focus on accurate protein tracking and calorie targets."}'::jsonb;
