...
export const FloatingWidget: React.FC<FloatingWidgetProps> = ({
  ...
  return (
    <motion.button
      ...
      className={cn(
        "fixed bottom-24 sm:bottom-28 right-3.5 sm:right-[calc(50%-210px)] w-10 h-10 sm:w-12 sm:h-12 rounded-full flex items-center justify-center bg-orange-500 hover:bg-orange-600 text-white shadow-lg shadow-orange-500/25 z-40 border-none cursor-pointer transition-all active:scale-95 select-none"
      )}
      title={getLabel()}
    >
      {renderIcon()}
