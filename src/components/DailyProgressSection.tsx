...
export function DailyProgressSection({
  ...
  return (
    <div className="px-4 sm:px-6 mt-1.5 relative z-10 font-sans">
      {/* Circular Progress for Calories */}
      <div className="relative w-full aspect-square max-w-[175px] sm:max-w-[195px] mx-auto flex items-center justify-center my-2 sm:my-3">
        <svg
        ...
        <div className="text-center z-10 bg-white/60 backdrop-blur-md w-28 h-28 sm:w-32 sm:h-32 rounded-full flex flex-col items-center justify-center shadow-inner border border-white/60">
          <div className="text-2xl sm:text-3xl font-black mb-0.5 text-orange-950 px-2 truncate selection:bg-orange-500 select-none">
            {totalCalories.toLocaleString()}
          </div>
          <div className="h-1 w-5 bg-orange-500 rounded-full mb-0.5" />
          <div className="text-orange-900/50 font-black tracking-[0.08em] text-[8.5px] uppercase">
      ...
      {(() => {
        ...
        return (
          <div className="mt-3 flex flex-col gap-2">
            <div className="bg-white/60 backdrop-blur-md p-3.5 sm:p-4 rounded-2xl border border-white/80 shadow-lg shadow-orange-100/20 overflow-hidden">
              {pages.length === 1 ? (
